...
from .serializers import RegisterSerializer,LoginSerializer,UserUpdateSerializer,LogoutSerializer,ResetRequestSetNewPasswordSerializer,ChangePasswordSerializer,EmailVerificationSerializer,UserSerializer
...
class PasswordResetRequestView(APIView):
    ...
    def post(self, request):
        ...
        if User.objects.filter(email=email).exists():
            ...
            send_otp_email_task.delay(subject, email_body, user.email)
