...
class Train(models.Model):
    ...
    supplier = models.ForeignKey('account.Supplier', on_delete=models.SET_NULL, null=True, related_name='trains')
...
class SeatReservation(models.Model):
    ...
    def __str__(self):
        return f"Reservation {self.reservation_number} for Seat {self.seat.seat_number} on Trip {self.trip.id} for {self.reservation_date}"
