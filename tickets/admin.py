...
from .models import Train, Station, Trips, Seat, Ticket,SeatReservation
...
class SeatReservationAdmin(admin.ModelAdmin):
    list_display = ('trip', 'seat', 'reserved', 'reservation_number', 'reservation_date')
    list_filter = ('trip', 'reservation_date', 'reserved')
    search_fields = ('seat__seat_number', 'trip__id', 'reservation_number')


@admin.register(Seat)
class SeatAdmin(admin.ModelAdmin):
    list_display = ('seat_number', 'class_type', 'train', )
